...
parser.add_argument('--pretrainToken', type=str, default='microsoft/BiomedNLP-PubMedBERT-base-uncased-abstract-fulltext', help='pretrain_token')
...
tokenizer = AutoTokenizer.from_pretrained(hyper_args.pretrainToken)
tokens = entity_list
